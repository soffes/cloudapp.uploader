 ...
 */
@interface RMUploadCredentials : NSObject <AFPropertyList, NSCopying>

/*!
	@brief Called to initialise an account from disk.
...
/*!
	@brief The plugin that the account belongs to.
...
/*!
	@brief
	This should be a string which is meaningful to the user, suitable for showing them as a later authentication choice. This is required and will throw an exception if not implemented by your subclass.
