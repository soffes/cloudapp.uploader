...
/*!
	@brief
	This function checks to see if an object can be serialised into a plist before trying, where doing so would cause an exception.
 
	@detail
	For collections, they are recursively checked.
 */
